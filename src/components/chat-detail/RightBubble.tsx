    ...
    return (
        <>
            ...
            {message.msg_type === 'PLG' && (
                <div className="flex flex-col items-end gap-[4px]">
                    <div className="flex items-end gap-[8px]">
                        <div className="max-w-[238px] p-[16px] bg-point-500 text-gray-100 text-label-l font-semibold rounded-t-2xl rounded-bl-2xl flex items-center gap-[10px]">
                            <div
                                onClick={() =>
                                    navigate(`/please/${message.msg}`)
                                }
                                className="flex items-center justify-center w-[24px] h-[24px] p-[5px] bg-point-400 rounded-full cursor-pointer hover:bg-point-600 active:bg-point-600"
                            >
                                <ArrowLeftIcon className="text-point-50" />
                            </div>
                            <img
                            ...
                            <div className="flex flex-col justify-center gap-[2px]">
                                ...
                                <span className="text-detail text-point-300">
                                    멍멍이 부탁을 전송했어요!
                                </span>
                            </div>
                        </div>
